...
def create_venue_submission():
  try:
    venue = Venue(
      ...
      genres = request.form['genres'], #check
      facebook_link = request.form['facebook_link'],
      image_link = request.form['image_link'],
      website = request.form['website_link'],
      seeking_talent = 'seeking_talent' in request.form, #edited
...
def show_artist(artist_id):
  ...
  artist['past_shows'] = [{
    ...
    "venue_name": Venue.query.get(show.venue_id).name,#Venue.query(Venue.name).get(show.venue_id),
    "venue_image_link": Venue.query.get(show.venue_id).image_link,#Venue.query(Venue.image_link).get(show.venue_id),
